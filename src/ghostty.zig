...
pub const ROW_DATA_KITTY_VIRTUAL_PLACEHOLDER = c.GHOSTTY_ROW_DATA_KITTY_VIRTUAL_PLACEHOLDER;

// Terminal cursor data constants
pub const DATA_CURSOR_X = c.GHOSTTY_TERMINAL_DATA_CURSOR_X;
pub const DATA_CURSOR_Y = c.GHOSTTY_TERMINAL_DATA_CURSOR_Y;
